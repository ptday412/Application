...
def genarate_ai_diary(images, moods, hashtags):
    ...
    object_key = tmp_object_key.split('.com')[1] #tmp_object_key.split('.com')은 이런 값으로 변경됨. 이 중 키 부분인 인덱스 1의 값을 키로 사용['https://test-kilolog.s3.ap-northeast-2.amazonaws', '/youngkyu/2024-12-15/test_image.jpg']
    emotion = moods
